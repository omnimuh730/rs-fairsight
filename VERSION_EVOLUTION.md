...
InnoMonitor is a cross-platform time tracking and monitoring application built with Tauri (Rust) and React. This document outlines the evolution of the application through its major version releases.
...
The initial foundation of InnoMonitor was laid with core infrastructure and basic functionality:
