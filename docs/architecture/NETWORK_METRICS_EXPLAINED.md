...
This document explains all the metrics and terminology used in the **Traffic Monitor** and **Network Activity** tabs of InnoMonitor.
...
*This documentation covers all metrics displayed in InnoMonitor's network monitoring features. For technical support or questions, refer to the main README.md file.*
