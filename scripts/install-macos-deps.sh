...
main() {
    ...
    echo "   DO NOT run with 'sudo' directly - this causes setugid errors."
    echo ""
    echo "✅ To launch InnoMonitor properly:"
    echo "   Method 1 (Recommended): Use the launcher script"
    echo "     bash launch-innomonitor.sh"
    echo ""
    echo "   Method 2: Add to System Settings"
    echo "     1. System Settings → Privacy & Security → Full Disk Access"
    echo "     2. Add InnoMonitor.app to allowed apps"
    echo "     3. Then: open /Applications/InnoMonitor.app"
    echo ""
